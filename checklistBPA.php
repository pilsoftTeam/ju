...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">      
      ...
      <h2 class="alert alert-info text-center" id="titulo"><b>REVISI&Oacute;N BECA PATAGONIA AYS&Eacute;N EDU. SUPERIOR</b></h2>      
      <div class="well well-sm">        
        ...
        <form action="procesarChecklistsBPA.php" method="post" id="checklistForm" class="form-horizontal" role="form">
            <fieldset>
                <?php
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr class="text-danger">
                            ...
                            <td class="text-center">
                                <input type="checkbox" name="certificadoNotasMediaNem" id="" value="COMPLETO" class="revDocumental" />
                            </td>
                        </tr>
                        <tr class="text-danger">
                            <td>Certificado PSU con puntaje igual o superior a 550 pts.</td>
                            <td class="text-center">
                                <input type="checkbox" name="certificadoPsuIgualMayor550pts" id="" value="COMPLETO" class="revDocumental" />
                            </td>
                        </tr>
                        <tr class="text-danger">
                            <td>Certificado de aprobaci&oacute;n curricular mayor o igual a 70%</td>
                            <td class="text-center">
                                <input type="checkbox" name="certificadoAprobCurriMayorIgual70pcto" id="" value="COMPLETO" class="revDocumental" />
                            </td>
                        </tr>                        
                        <tr class="text-danger">
                        ...
                        <tr class="text-danger">
                            <td>Certificado de egreso o concentraci&oacute;n de notas de ense&ntilde;anza media de un establecimiento educacional de la regi&oacute;n de Ays&eacute;n</td>
                            <td class="text-center"><input type="checkbox" name="certifEgresoConcentNotasMediaDeEstEduDeRegionDeAysen" id="" value="COMPLETO" class="revDocumental" /></td>
                        </tr>                        
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed">
                        <tr>
                            <td colspan="4"><h4><strong>Institici&oacute;n del Estudiante de Educaci&oacute;n Superior</strong><span class="text-warning"> ( *nuevo campo [Lista BD] )</span></h4></td>                            
                        </tr>
                        <tr>                            
