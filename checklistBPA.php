...
if ('FALSE' == $existePostulante['respuesta']) {
    ...
    <html lang="es">
    <head>
        <title>Checklist BPA - Becas de Mantenci&oacute;n Junaeb 2017</title>
    ...
    <div class="container">
        ...
        <h2 class="alert alert-info text-center" id="titulo"><b>REVISI&Oacute;N BECA PATAGONIA AYS&Eacute;N EDU.
                SUPERIOR</b></h2>
        <div class="well well-sm">
            ...
            <form action="procesarChecklistsBPA.php" method="post" id="checklistForm" class="form-horizontal"
                  role="form">
                <fieldset>
                    <?php
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr class="active">
                                    ...
                                    <th class="text-center"><h4><strong>BPA SUP</strong></h4></th>
                                </tr>
                                ...
                                <tr class="text-danger">
                                    <td>Certificado de notas de ense&ntilde;anza media (NEM)</td>
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoNotasMediaNem" id="" value="COMPLETO"
                                               class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Certificado PSU con puntaje igual o superior a 550 pts.</td>
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoPsuIgualMayor550pts" id=""
                                               value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Certificado de aprobaci&oacute;n curricular mayor o igual a 70%</td>
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoAprobCurriMayorIgual70pcto" id=""
                                               value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                ...
                                <tr class="text-danger">
                                    <td>Certificado de egreso o concentraci&oacute;n de notas de ense&ntilde;anza media
                                        de un establecimiento educacional de la regi&oacute;n de Ays&eacute;n
                                    </td>
                                    <td class="text-center"><input type="checkbox"
                                                                   name="certifEgresoConcentNotasMediaDeEstEduDeRegionDeAysen"
                    ...
                    <div id="verAntecedentes" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiInstitucionEduSup', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiNombreCarrera', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiAnioIngresoCarrera', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiDuracionCarrera', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="comuDomicilioFamiliarSinab"><b><?php #echo $antecedentesPostulante[''];
                                                ?></b></span>
                            ...
                            <?php
                            crearSelectObservaciones('ComuDomicilioFamiliar', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('ComuDomicilioEstudios', 'BPA');
                            ?>
                        </div>
                    </div> <!-- /verAntecedentes -->
                    ...
                    <div id="verAcademica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiNota', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiNem', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiAprobacionCurricular', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiPsu', 'BPA');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verEconomica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigitramoRSH', 'BPA');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verFactoresRiesgo" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiDiscapacidad', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiDeficitApoyoFamiliar', 'BPA');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verEducacion" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiDuplicidadFuncionesAlumno', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiHermanosHijosEstudiantes', 'BPA');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verTerritorial" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiAislamientoPromedioComunal', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiAislamientoDeLocalidades', 'BPA');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="lugarEstudioAlumnoPapel"
                                            ...
                                            <option value="Fuera de la Regi�n">Fuera de la Regi&oacute;n</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                            ...
                            <?php
                            crearSelectObservaciones('DigiLugarEstudioAlumno', 'BPA');
                            ?>
                        </div>
                    </div>
