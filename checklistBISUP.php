...
if ('FALSE' == $existePostulante['respuesta']) {
    ...
    <html lang="es">
    <head>
        <title>Checklist BISUP - Becas de Mantenci&oacute;n Junaeb 2017</title>
    ...
    <div class="container">
        ...
        <h2 class="alert alert-info text-center" id="titulo"><b>REVISI&Oacute;N BECA IND&Iacute;GENA EDU. SUPERIOR</b>
        </h2>
                ...
                <fieldset>
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <label class="checkbox-inline">
                                    ...
                                    <input type="text" name="obsRutAlumno" id="obsRutAlumno"
                                           class="form-control input-sm" placeholder="Observaci�n Rut" maxlength="50"/>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <label class="checkbox-inline">
                                    ...
                                    <input type="text" name="obsNombreAlumno" id="obsNombreAlumno"
                                           class="form-control input-sm" placeholder="Observaci�n Nombres"
                                           maxlength="50"/>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr class="active">
                                    ...
                                    <th class="text-center"><h4><strong>BI SUP</strong></h4></th>
                                </tr>
                    ...
                    <div id="verAntecedentes" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Institici&oacute;n del Estudiante de Educaci&oacute;n
                                                Superior</strong><span
                            ...
                            <?php crearSelectObservaciones('DigiInstitucionEduSup', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiNombreCarrera', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>A�o de Ingreso</strong></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                    <th>Registro Digitaci&oacute;n</th>
                            ...
                            <?php crearSelectObservaciones('DigiAnioIngresoCarrera', 'BISUP'); ?>
                        </div>

                        <!-- Duraci�n Carrera (En Semestres) -->
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                            ...
                            <?php crearSelectObservaciones('DigiDuracionCarrera', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiPuebloIndigena', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiAcreditadoPorCertificadoConadi', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiAcreditadoPorApellido', 'BISUP'); ?>
                        </div>
                    </div>
                    ...
                    <div id="verAcademica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiNota', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiAprobacionCurricular', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiPsu', 'BISUP'); ?>
                        </div>
                    </div>
                    ...
                    <div id="verEconomica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigitramoRSH', 'BISUP'); ?>
                        </div>
                    </div>
                    ...
                    <div id="verFactoresRiesgo" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiDiscapacidad', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="deficitApoyoFamiliarPapel"
                                            ...
                                            <option value="S�lo A cargo de Cuidadores">S�lo A cargo de Cuidadores
                                            </option>
                            ...
                            <?php crearSelectObservaciones('DigiDeficitApoyoFamiliar', 'BISUP'); ?>
                        </div>
                    </div>
                    ...
                    <div id="verEducacion" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiDuplicidadFuncionesAlumno', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="hermanosHijosEstudiantesPapel"
                                            ...
                                            <option value="En Educaci�n Superior Residencia">En Educaci�n Superior
                                                Residencia
                                            </option>
                                            <option value="En Educaci�n Superior Fuera Residencia">En Educaci�n Superior
                                                Fuera Residencia
                                            </option>
                                        </select>
                                    </td>
                            ...
                            <?php crearSelectObservaciones('DigiHermanosHijosEstudiantes', 'BISUP'); ?>
                        </div>
                    </div>
                    ...
                    <div id="verSocioCultural" class="dimension" style="display: none;">
                        ...
                        <!-- Participaci�n en organizaci�n Ind�gena -->
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                            ...
                            <?php crearSelectObservaciones('DigiParticipacionOrgIndigena', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiSeDomiciliaViveEnComunidadIndigena', 'BISUP'); ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php crearSelectObservaciones('DigiParticipaDePracticasCulturalesRitualesDeLaComunidad', 'BISUP'); ?>
                        </div>
                    </div>
                    <br>
                    <hr>
