                ...
                <fieldset>
                    ...
                    <div id="verGenerales" class="dimension" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['rut']; ?></strong>
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['nombreAlumno']; ?></strong>
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['direccionAlumno']; ?></strong>
                                </p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr class="text-danger">
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="concentracionNotasUltAnioAcad" id="" value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
