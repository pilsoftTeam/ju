...
<html lang="es">
  <head>
    <title>RUT para Carga de Documentos - Becas Junaeb 2017</title>
  ...
  <body>
    <div class="container">      
      ...
      <div class="well well-sm">      
        <h4 class="text-center alert alert-info"><b>CARGA Y REGISTRO DE DOCUMENTOS</b></h4>
        
        <form action="CargaDocsBecas.php" method="post" id="formRutCargaDocs" class="form-horizontal" role="form">
            <fieldset>
...
$(document).ready(function(){
    alert('Para realizar pruebas de carga de docs. ingrese RUT 21836942 y BI B&M.');
