...
if (isset($_POST['estadoChecklist']) && $_POST['estadoChecklist'] != '') {
    ...
    $query = "CALL BIBM_SUP_InsertarDatos(" . $idRevisor . ", '" . $bibm_regionDeEjecucion . "', '" . $bibm_estadoChecklist . "', '" . $bibm_codEstadoChecklist . "', '" . $rutAlumno . "', "
        ...
        . "'" . $bibm_puebloIndigenaSinab . "', '" . $bibm_resultadoDigiPuebloIndigena . "', '" . $bibm_acreditadoPorCertificadoConadiPapel . "', '" . $bibm_acreditadoPorCertificadoConadiSinab . "', "
        ...
        . "'" . $bibm_deficitApoyoFamiliarPapel . "', '" . $bibm_deficitApoyoFamiliarEmp . "', '" . $bibm_resultadoDigiDeficitApoyoFamiliar . "', "
        ...
        . "'" . $bibm_resultadoDigiParticipaDePracticasCulturalesRitualesDeLaComunidad . "', '" . $bibm_aislamientoPromedioComunalPapel . "', '" . $bibm_aislamientoPromedioComunalSinab . "', "
        . "'" . $bibm_aislamientoPromedioComunalEmp . "', '" . $bibm_resultadoDigiAislamientoPromedioComunal . "', "
