  ...
  <body>
    ...
    <div class="container">      
      ...
      <div class="well well-sm">        
        ...
        <form action="procesarChecklistsBA.php" method="post" id="checklistForm" class="form-horizontal" role="form">
            <fieldset>
                <?php
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr class="text-danger">
                            ...
                            <td class="text-center">
                                <input type="checkbox" name="certificadoPsuRendidaCuandoIesLoExija" id="" value="COMPLETO" class="revDocumental" />
                            </td>
                        </tr>
                        <tr class="text-danger">
