...
if ('FALSE' == $existePostulante['respuesta']) {
    ...
    <html lang="es">
    <head>
        <title>Checklist BA - Becas de Mantenci&oacute;n Junaeb 2017</title>
    ...
    <div class="container">
        ...
        <h2 class="alert alert-info text-center" id="titulo"><b>REVISI&Oacute;N BECA AYS&Eacute;N EDU. SUPERIOR</b></h2>
        <div class="well well-sm">
            ...
            <form action="procesarChecklistsBA.php" method="post" id="checklistForm" class="form-horizontal"
                  role="form">
                <fieldset>
                    <?php
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr class="active">
                                    ...
                                    <th class="text-center"><h4><strong>BA SUP</strong></h4></th>
                                </tr>
                                ...
                                <tr class="text-danger">
                                    <td>Certificado PSU rendida cuando la I.E.S as&iacute; lo exija</td>
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoPsuRendidaCuandoIesLoExija" id=""
                                               value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
