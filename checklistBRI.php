...
if ('FALSE' == $existePostulante['respuesta']) {
    ...
    <div class="container">
        ...
        <h2 class="alert alert-info text-center" id="titulo"><b>REVISI&Oacute;N BECA RESIDENCIA IND&Iacute;GENA EDU.
                SUPERIOR</b></h2>
        <div class="well well-sm">
            <ul class="nav nav-tabs nav-justified" style="font-size: 11px; font-weight:;">
                <li id="linkGenerales" class="pestanas"><a href="#datosGenerales"
                                                           style="background: #E0E0E0;">GENERAL</a></li>
                <li id="linkDocumental" class="pestanas"><a href="#documental"
                                                            style="background: #5EAEAE;">DOCUMENTAL</a></li>
                <li id="linkAntecedentes" class="pestanas"><a href="#antecedentes" style="background-color: #EC7600;">ANTECEDENTES</a>
                </li>
                <li id="linkAcademica" class="pestanas"><a href="#academica" style="background-color: #FFFF2D;">ACAD&Eacute;MICA</a>
                </li>
                <li id="linkEconomica" class="pestanas"><a href="#economica" style="background-color: #9191C8">ECON&Oacute;MICA</a>
                </li>
                <li id="linkFactoresRiesgo" class="pestanas"><a href="#factoresRiesgo"
                                                                style="background-color: #FF9428">FACT. RIESGO</a></li>
                <li id="linkEducacion" class="pestanas"><a href="#educacion" style="background-color: #359AFF;">EDUCACI&Oacute;N</a>
                </li>
                <li id="linkSocioCultural" class="pestanas"><a href="#socioCultural" style="background-color: #1AFF53">SOCIOCULTURAL</a>
                </li>
                <li id="linkTerritorial" class="pestanas"><a href="#territorial" style="background-color: #CBCB96">TERRITORIAL</a>
                </li>
            </ul>

            <br/>
            <!--  enctype="multipart/form-data" -->
            <form action="procesarChecklistsBRI.php" method="post" id="checklistForm" class="form-horizontal"
                  role="form">
                <fieldset>
                    <?php
                    ...
                    <div id="verGenerales" class="dimension" style="display: none;">
                        ...
                        <input type="hidden" name="regionDeEjecucion"
                               value="<?php echo $datosGrales['region_ejecucion']; ?>"/>
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <label class="checkbox-inline">
                                    ...
                                    <input type="text" name="obsRutAlumno" id="obsRutAlumno"
                                           class="form-control input-sm" placeholder="Observación Rut" maxlength="100"/>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['nombreAlumno']; ?></strong></p>
                                <input type="hidden" name="nombreAlumno"
                                       value="<?php echo $datosGrales['nombreAlumno']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['direccionAlumno']; ?></strong></p>
                                <input type="hidden" name="domicilioAlumno"
                                       value="<?php echo $datosGrales['direccionAlumno']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                ...
                                <input type="hidden" name="nivelEducacional"
                                       value="<?php echo $datosGrales['curso']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['provincia_domicilio']; ?></strong></p>
                                <input type="hidden" name="provinciaDomicilioFamiliarAlumno"
                                       value="<?php echo $datosGrales['provincia_domicilio']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['comuna_domicilio']; ?></strong></p>
                                <input type="hidden" name="comunaDomicilioFamiliarAlumno"
                                       value="<?php echo $datosGrales['comuna_domicilio']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['unidad_operativa']; ?></strong></p>
                                <input type="hidden" name="tipoUnidadOperativa"
                                       value="<?php echo $datosGrales['unidad_operativa']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-4 col-sm-3 col-md-2">Instituci&oacute;n
                                Evaluadora:</label>
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['unidad_operativa']; ?></strong></p>
                                <input type="hidden" name="institucionEvaluadora"
                                       value="<?php echo $datosGrales['unidad_operativa']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-9 col-md-10">
                                <p class="form-control-static">
                                    <strong><?php echo $datosGrales['nombreProfesional']; ?></strong></p>
                                <input type="hidden" name="profesionalQueEvaluo"
                                       value="<?php echo $datosGrales['nombreProfesional']; ?>"/>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr class="text-danger">
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoParticipacionOrgIndigena" id=""
                                               value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Certificado se domicilia o vive en comunidad ind&iacute;gena</td>
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoSeDomiciliaViveEnComunidadIndigena"
                                               id="" value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Certificado de participa de pr&aacute;cticas y/o celebraciones rituales de la
                                        comunidad o pueblo al que pertenece
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox"
                                               name="certificadoParticipaDePracticasCulturalesRitualesDeLaComunidad"
                                               id="" value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Certificado Conadi que acredite calidad ind&iacute;gena</td>
                                    <td class="text-center"><input type="checkbox" name="certificadoConadiAlumno" id=""
                                                                   value="COMPLETO" class="revDocumental"/></td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Certificado de residencia del domicilio familiar que acredite comuna y
                                        localidad
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" name="certificadoRecidDomiFamiAcredComunaLocalidad" id=""
                                               value="COMPLETO" class="revDocumental"/>
                                    </td>
                                </tr>
                                <tr class="text-danger">
                                    <td>Concentraci&oacute;n de notas del &uacute;ltimo a&ntilde;o acad&eacute;mico
                                        cursado
                                    </td>
                                    <td class="text-center"><input type="checkbox" name="concentracionNotasUltAnioAcad"
                                                                   id="" value="COMPLETO" class="revDocumental"/></td>
                                </tr>
                                <tr class="text-danger">
                                ...
                                <tr class="text-danger">
                                    ...
                                    <td class="text-center"><input type="checkbox" name="documentoArriendoInmueble"
                                                                   id="" value="COMPLETO" class="revDocumental"/></td>
                                </tr>
                    ...
                    <div id="verAntecedentes" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Institici&oacute;n de Educaci&oacute;n Superior</strong><span
                                                    class="text-warning"> ( *nuevo campo [Lista BD] )</span></h4></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="institucionEduSupPapel"
                                                id="institucionEduSupPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="IES...">IES...</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="institucionEduSupSinab"><b>IES...<?php //echo
                                                ?></b></span>
                                        <input type="hidden" name="institucionEduSupSinab" value="<?php //echo
                                        ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="institucionEduSupEmp"
                                                id="institucionEduSupEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="IES...">IES...</option>
                                        </select>
                                    </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Carrera (nombre)</strong><span class="text-warning"> ( *Lista BD [NO usar utf8_ci en Query] )</span>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="nombreCarreraSinab"><b>carreras...<?php //echo
                                                ?></b></span>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="anioIngresoCarreraPapel"
                                                id="anioIngresoCarreraPapel">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="anioIngresoCarreraSinab"><b>2017<?php //echo
                                                ?></b></span>
                                        <input type="hidden" name="anioIngresoCarreraSinab" value="<?php //echo
                                        ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="anioIngresoCarreraEmp"
                                                id="anioIngresoCarreraEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="2008">2008</option>
                                            <option value="2009">2009</option>
                                            <option value="2010">2010</option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Duraci&oacute;n Carrera (En Semestres)</strong></h4>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="duracionCarreraPapel"
                                                id="duracionCarreraPapel">
                                            <option value="">Seleccione...</option>
                                            <?php for ($i = 2; $i <= 18; $i++) { ?>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="duracionCarreraSinab"><b>2<?php //echo
                                                ?></b></span>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="puebloIndigenaPapel"
                                                id="puebloIndigenaPapel">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="puebloIndigenaSinab"
                                               value="<?php echo $antecedentesPostulante['etnia_bi']; ?>"/>
                                    </td>
                                    <td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <input type="number" name="acreditadoPorCertificadoConadiPapel"
                                               id="acreditadoPorCertificadoConadiPapel" class="form-control" min="0"
                                               max="99999999" step="1" required="required" maxlength="8"/>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="acreditadoPorCertificadoConadiSinab"><b><?php echo $antecedentesPostulante['certificado_conadi']; ?></b></span>
                                        <input type="hidden" name="acreditadoPorCertificadoConadiSinab"
                                               value="<?php echo $antecedentesPostulante['certificado_conadi']; ?>"/>
                                    </td>
                                    <td>
                                        <input type="number" name="acreditadoPorCertificadoConadiEmp"
                                               id="acreditadoPorCertificadoConadiEmp" class="form-control" min="0"
                                               max="99999999" step="1" required="required" maxlength="8"/>
                                    </td>
                                    <td class="valor-resultado text-center" style="vertical-align: middle;">
                                        <span id="resultadoDigiAcreditadoPorCertificadoConadi" class="label"></span>
                                        <input type="hidden" name="resultadoDigiAcreditadoPorCertificadoConadi"
                                               value=""/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="cerfificadoConadiPrecargado"
                                               id="cerfificadoConadiPrecargado" value="SI"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="acreditadoPorApellidoPapel"
                                                id="acreditadoPorApellidoPapel">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="acreditadoPorApellidoSinab"
                                               value="<?php echo $antecedentesPostulante['acreditacion_por_apellidos']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="acreditadoPorApellidoEmp"
                                                id="acreditadoPorApellidoEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="apellidoIndigenaDirecto"
                                               id="apellidoIndigenaDirecto" value="SI"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="regionDomicilioFamiliarPapel"
                                                id="regionDomicilioFamiliarPapel">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="regionDomicilioFamiliarSinab"><b>1<?php #echo $antecedentesPostulante[''];
                                                ?></b></span>
                                        <input type="hidden" name="regionDomicilioFamiliarSinab"
                                               value="<?php #echo $antecedentesPostulante[''];
                                               ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="regionDomicilioFamiliarEmp"
                                                id="regionDomicilioFamiliarEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="1">1</option>
                                        </select>
                                    </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="comuDomicilioFamiliarPapel"
                                                id="comuDomicilioFamiliarPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="1">1</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="comuDomicilioFamiliarSinab"><b>1<?php #echo $antecedentesPostulante[''];
                                                ?></b></span>
                                        <input type="hidden" name="comuDomicilioFamiliarSinab"
                                               value="<?php #echo $antecedentesPostulante[''];
                                               ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="comuDomicilioFamiliarEmp"
                                                id="comuDomicilioFamiliarEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="1">1</option>
                                        </select>
                                    </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="comuDomicilioEstudiosPapel"
                                                id="comuDomicilioEstudiosPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="1">1</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="comuDomicilioEstudiosSinab"><b>1<?php #echo $antecedentesPostulante[''];
                                                ?></b></span>
                                        <input type="hidden" name="comuDomicilioEstudiosSinab"
                                               value="<?php #echo $antecedentesPostulante[''];
                                               ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="comuDomicilioEstudiosEmp"
                                                id="comuDomicilioEstudiosEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="1">1</option>
                                        </select>
                                    </td>
                    ...
                    <div id="verAcademica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Calificaci&oacute;n Acad&eacute;mica,
                                                Nota</strong></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="notaSinab"
                                               value="<?php echo $dimAcademica['nota']; ?>"/>
                                    </td>
                                    <td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>NEM</strong><span class="text-warning"> ( *Tipo de Dato x Definir )</span>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="nemSinab"><b>NEM...<?php //echo
                                                ?></b></span>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Aprobaci&oacute;n Curricular</strong><span
                                                    class="text-warning"> ( *Tipo de Dato x Definir )</span></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                    <th>Registro Digitaci&oacute;n</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="aprobacionCurricularPapel"
                                                id="aprobacionCurricularPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="curricular...">curricular...</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="aprobacionCurricularSinab"><b>curricular...<?php //echo
                                                ?></b></span>
                                        <input type="hidden" name="aprobacionCurricularSinab" value="<?php //echo
                                        ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="aprobacionCurricularEmp"
                                                id="aprobacionCurricularEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="curricular...">curricular...</option>
                                        </select>
                                    </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>PSU</strong><span class="text-warning"> ( *Dato Requerido ?? )</span>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <input type="number" name="psuPapel" id="psuPapel" class="form-control" min="0"
                                               max="999" step="1" required="required"/>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="psuSinab"><b>0<?php //echo
                                                ?></b></span>
                                        <input type="hidden" name="psuSinab" value="<?php //echo
                                        ?>"/>
                                    </td>
                                    <td>
                                        <input type="number" name="psuEmp" id="psuEmp" class="form-control" min="0"
                                               max="999" step="1" required="required"/>
                                    </td>
                                    <td class="valor-resultado text-center" style="vertical-align: middle;">
                    ...
                    <div id="verEconomica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Tramo Registro Social de Hogares (RSH)</strong>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                    ...
                    <div id="verFactoresRiesgo" class="dimension" style="display: none;">
                            ...
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="discapacidadSinab"
                                               value="<?php echo $dimFactRiesgo['discapacidad']; ?>"/>
                                    </td>
                                    <td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable D&eacute;ficit en Red de Apoyo
                                                Familiar</strong></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                    <th>Registro Digitaci&oacute;n</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="deficitApoyoFamiliarPapel"
                                                id="deficitApoyoFamiliarPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="Familia Nuclear Biparental">Familia Nuclear Biparental
                                            </option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="deficitApoyoFamiliarSinab"
                                               value="<?php echo $dimFactRiesgo['deficit_apoyo']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="deficitApoyoFamiliarEmp"
                                                id="deficitApoyoFamiliarEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="Familia Nuclear Biparental">Familia Nuclear Biparental
                                            </option>
                                            <option value="Familia Monoparental">Familia Monoparental</option>
                    ...
                    <div id="verEducacion" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Duplicidad de funciones del estudiante</strong>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="duplicidadFuncionesAlumnoSinab"
                                               value="<?php echo $dimEducacion['duplicidad_funciones']; ?>"/>
                                    </td>
                                    <td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="hermanosHijosEstudiantesPapel"
                                                id="hermanosHijosEstudiantesPapel">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="hermanosHijosEstudiantesSinab"
                                               value="<?php echo $dimEducacion['hermanos_estudiantes']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="hermanosHijosEstudiantesEmp"
                                                id="hermanosHijosEstudiantesEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="No tiene hermanos o hijos estudiando">No tiene hermanos o
                                                hijos estudiando
                                            </option>
                    ...
                    <div id="verSocioCultural" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Participaci&oacute;n en organizaci&oacute;n Ind&iacute;gena</strong>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="participaEnOrgIndigenaPapel"
                                                id="participaEnOrgIndigenaPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="participaEnOrgIndigenaSinab"
                                               value="<?php echo $dimSocioCultural['organizacion_indigena']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="participaEnOrgIndigenaEmp"
                                                id="participaEnOrgIndigenaEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Se domicilia o vive en comunidad ind&iacute;gena</strong>
                                        </h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="seDomiciliaViveEnComunidadIndigenaPapel"
                                                id="seDomiciliaViveEnComunidadIndigenaPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="seDomiciliaViveEnComunidadIndigenaSinab"
                                               value="<?php echo $dimSocioCultural['comunidad_indigena']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="seDomiciliaViveEnComunidadIndigenaEmp"
                                                id="seDomiciliaViveEnComunidadIndigenaEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                    ...
                                    <td class="valor-resultado text-center" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="resultadoDigiSeDomiciliaViveEnComunidadIndigena"
                                               value=""/>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Participa de pr&aacute;cticas culturales y/o
                                                celebraciones rituales de la comunidad o pueblo al que
                                                pertenece</strong></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                    <th>Registro Digitaci&oacute;n</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control"
                                                name="participaDePracticasCulturalesRitualesDeLaComunidadPapel"
                                                id="participaDePracticasCulturalesRitualesDeLaComunidadPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden"
                                               name="participaDePracticasCulturalesRitualesDeLaComunidadSinab"
                                               value="<?php echo $dimSocioCultural['participa_rituales']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control"
                                                name="participaDePracticasCulturalesRitualesDeLaComunidadEmp"
                                                id="participaDePracticasCulturalesRitualesDeLaComunidadEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                    ...
                                    <td class="valor-resultado text-center" style="vertical-align: middle;">
                                        <span id="resultadoDigiParticipaDePracticasCulturalesRitualesDeLaComunidad"
                                              class="label"></span>
                                        <input type="hidden"
                                               name="resultadoDigiParticipaDePracticasCulturalesRitualesDeLaComunidad"
                                               value=""/>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="verTerritorial" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Aislamiento Promedio Comunal</strong><span
                                                    class="text-warning"> ( *nuevo campo [Lista BD] )</span></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="aislamientoPromedioComunalPapel"
                                                id="aislamientoPromedioComunalPapel">
                                            <option value="">Seleccione Aislamiento...</option>
                                            <option value="Aislamiento">Aislamiento</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="aislamientoPromedioComunalSinab"><b>Aislamiento<?php //echo $dimTerritorial[''];
                                                ?></b></span>
                                        <input type="hidden" name="aislamientoPromedioComunalSinab"
                                               value="<?php //echo $dimTerritorial[''];
                                               ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="aislamientoPromedioComunalEmp"
                                                id="aislamientoPromedioComunalEmp">
                                            <option value="">Seleccione Aislamiento...</option>
                                            <option value="Aislamiento">Aislamiento</option>
                                        </select>
                                    </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Aislamiento de Localidades</strong><span
                                                    class="text-warning"> ( *nuevo campo [Lista BD] )</span></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="aislamientoDeLocalidadesPapel"
                                                id="aislamientoDeLocalidadesPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="Aislamiento">Aislamiento</option>
                                        </select>
                                    </td>
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="aislamientoDeLocalidadesSinab"><b>Aislamiento<?php //echo $dimTerritorial[''];
                                                ?></b></span>
                                        <input type="hidden" name="aislamientoDeLocalidadesSinab"
                                               value="<?php //echo $dimTerritorial[''];
                                               ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="aislamientoDeLocalidadesEmp"
                                                id="aislamientoDeLocalidadesEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="Aislamiento">Aislamiento</option>
                                        </select>
                                    </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Lugar de Estudio del Alumno/a</strong><span
                                                    class="text-warning"> ( *nuevo campo [Lista BD] )</span></h4></td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="lugarEstudioAlumnoPapel"
                                                id="lugarEstudioAlumnoPapel">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        <span id="lugarEstudioAlumnoSinab"><b><?php //echo $dimTerritorial[''];
                                                ?></b></span>
                                        <input type="hidden" name="lugarEstudioAlumnoSinab"
                                               value="<?php //echo $dimTerritorial[''];
                                               ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="lugarEstudioAlumnoEmp"
                                                id="lugarEstudioAlumnoEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="En la comuna">En la comuna</option>
                                            <option value="Fuera de la comuna">Fuera de la comuna</option>
                                            <option value="Fuera de la Provincia">Fuera de la Provincia</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-10">
                            <select name="codEstadoChecklist" id="codEstadoChecklist" class="form-control">
                                ...
                                <option value="CC1">Formulario revisado NO presenta errores (sin documentaci&oacute;n
                                    faltante, aspectos normativos correctos y sin errores de digitaci&oacute;n).
                                </option>
                                <option value="CC2">Con errores de transcripci&oacute;n de informaci&oacute;n en Papel
                                    v/s Form. Digital y/o coherencia interna del Form. digital respecto a normativa, se
                                    modifica Sinab.
                                </option>
                                <option value="CC3">Se detecta documentaci&oacute;n faltante, &eacute;sta se gestiona,
                                    se obtiene con estudiante o red colaboradora, y se modifica el formulario en Sinab.
                                </option>
                                <option value="CC4">Se detecta documentaci&oacute;n faltante, &eacute;sta se gestiona,
                                    NO se obtiene con estudiante o red colaboradora, y se modifica formulario en Sinab
                                    si corresponde.
                                </option>
                            </select>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <button type="submit" name="guardarBRI" class="btn btn-primary btn-lg pull-right">Guardar
                                Revisi&oacute;n
                            </button>
                        </div>
                    </div>
