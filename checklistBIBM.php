                ...
                <fieldset>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr class="text-danger">
                                    <td>Certificado de participaci&oacute;n del padre, madre o representante legal en
                                        organizaci&oacute;n ind&iacute;gena
                                    </td>
                    ...
                    <div id="verAntecedentes" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Curso del Estudiante de Ense&ntilde;anza B&aacute;sica y
                                                Media</strong></h4></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="cursoBasicaMediaPapel"
                                                id="cursoBasicaMediaPapel">
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden" name="cursoBasicaMediaSinab"
                                               value="<?php echo $datosGrales['curso']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control" name="cursoBasicaMediaEmp"
                                                id="cursoBasicaMediaEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="Quinto B�sico">Quinto B�sico</option>
                                            <option value="Sexto B�sico">Sexto B�sico</option>
                                            <option value="S�ptimo B�sico">S�ptimo B�sico</option>
                            ...
                            <?php
                            crearSelectObservaciones('EduBasicaMedia', 'BIBM');
                            ?>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiPuebloIndigena', 'BIBM');
                            ?>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiAcreditadoPorCertificadoConadi', 'BIBM');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiAcreditadoPorApellido', 'BIBM');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verAcademica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiNota', 'BIBM');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verEconomica" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigitramoRSH', 'BIBM');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verFactoresRiesgo" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiDiscapacidad', 'BIBM');
                            ?>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            crearSelectObservaciones('DigiDeficitApoyoFamiliar', 'BIBM');
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="verSocioCultural" class="dimension" style="display: none;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                <tr>
                                    <td colspan="4"><h4><strong>Variable Participaci&oacute;n del padre, madre o
                                                representante legal en organizaci&oacute;n Ind&iacute;gena</strong></h4>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Registro Formulario</th>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control"
                                                name="participaPadreMadreRepresentanteLegalEnOrgIndigenaPapel"
                                                id="participaPadreMadreRepresentanteLegalEnOrgIndigenaPapel">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                    ...
                                    <td class="text-center bg-info" style="vertical-align: middle;">
                                        ...
                                        <input type="hidden"
                                               name="participaPadreMadreRepresentanteLegalEnOrgIndigenaSinab"
                                               value="<?php echo $dimSocioCultural['organizacion_indigena']; ?>"/>
                                    </td>
                                    <td>
                                        <select class="form-control"
                                                name="participaPadreMadreRepresentanteLegalEnOrgIndigenaEmp"
                                                id="participaPadreMadreRepresentanteLegalEnOrgIndigenaEmp">
                                            <option value="">Seleccione...</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <button type="submit" name="guardarBIBM" class="btn btn-primary btn-lg pull-right">Guardar
                                Revisi&oacute;n
                            </button>
                        </div>
                    </div>
